...
```python
class Nidhi:
    name       = "Nidhi D Trivedi"
    degree     = "B.Tech in Information Technology"
    university = "Atmiya University, Rajkot 🎓"
    location   = "Gujarat, India 🇮🇳"
    email      = "trivedinidhi261@gmail.com"
    interests  = ["Machine Learning", "Data Science", "Time Series Analysis", "Python"]
    currently  = "Exploring deep learning & building ML projects"
    internship = "Zidio Development (Data Science Intern)"
    fun_fact   = "I predicted stock prices before I could predict my own mood 📉📈"
...
**🔭 Currently building**
- ML pipelines with real financial data
...
- Built end-to-end stock forecasting suite with a team of 6
...
> 🏆 **Stock Market Time Series Forecasting** — End-to-end ML project built during my **Zidio internship**.
> Combined ARIMA, SARIMA & LSTM models with feature engineering (RSI, MACD, EMA, Bollinger Bands).
> Multi-horizon forecasting (7 → 180 days) with a full Streamlit dashboard + Power BI integration.
> Built with a team of 6. I led the project. **Python · TensorFlow · Streamlit · Power BI**
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/nidhi2131/nidhi2131/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nidhi2131/nidhi2131/output/github-snake.svg" />
  <img alt="github-snake" src="https://raw.githubusercontent.com/nidhi2131/nidhi2131/output/github-snake.svg" />
</picture>
...
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:trivedinidhi261@gmail.com)
&nbsp;
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/nidhi-trivedi-161ab9325)
&nbsp;
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nidhi2131)
...
⭐ **If you like what you see, drop a star — it keeps me going!** ⭐
...
Step 1: Create folder .github/workflows/ in this repo (nidhi2131/nidhi2131)
Step 2: Create file snake.yml inside it with this content:
...
Step 4: The snake SVG will appear automatically!
=======================================================
-->
